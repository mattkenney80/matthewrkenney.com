...
VALUES (
  'debris-fields',
  'Debris Fields',
  'On the film Flight, my father, and the debris fields we inherit and leave behind.',
  'family,essay,film',
  '2026-07-17',
  'Hollywood makes two kinds of movies about drinking. In the first kind, the bottle is a costume, something an actor holds while delivering dialogue. In the second kind, which is rare, the bottle is the antagonist, and it wins every scene it appears in. Flight is the second kind. It may be the best film ever made about alcoholism, and almost nobody talks about it, because everyone remembers the plane crash and forgets that the plane crash is the least dangerous thing in the picture.
