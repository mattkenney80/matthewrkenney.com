-- Add "Paying the Bill" article
INSERT INTO articles (slug, title, description, tags, date, body, published, created_at, updated_at)
VALUES (
  'paying-the-bill',
  'Paying the Bill',
  'A meditation on legacy, paying your debts, and what it means to be a good person',
  'family,philosophy,loss,legacy',
  '2026-07-09',
