-- Update "Truing the Wheel": new subtitle, revised background and degree lines
UPDATE articles
SET description = 'You cannot fix one spoke.',
    body = '## Part One
...
![Cartoon: an executive points at one spoke of a bicycle on a boardroom table](/images/articles/truing-1-another-department.jpg)
...
![Cartoon: a mechanic presents a badly warped wheel in a truing stand](/images/articles/truing-2-spoke-tighter.jpg)
...
![Cartoon: a candidate at a podium points to a single spoke above the crowd](/images/articles/truing-3-other-thirty-one.jpg)
...
![Cartoon: two figures with coffee watch a man work on a bike in the garage](/images/articles/truing-4-independent.jpg)',
    updated_at = CURRENT_TIMESTAMP
WHERE slug = 'truing-the-wheel';
